            ...
            <div class="max-w-5xl mx-auto p-6 md:p-12">
                ...
                <div class="bg-white rounded-[32px] p-8 md:p-12 mb-6 shadow-sm">
                    <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
                        ...
                        <div class="flex-1 text-center md:text-right">
                            ...
                            <a href="edit_profile.jsp" class="inline-flex items-center gap-2 bg-[#2563eb] hover:bg-[#1d4ed8] text-white px-8 py-3 rounded-2xl transition-colors font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="bg-white rounded-[32px] p-8 md:p-12 mb-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="edit_profile.jsp" class="group bg-[#f9fafb] hover:bg-blue-50 border-2 border-transparent hover:border-[#2563eb] rounded-[24px] p-6 transition-all">
